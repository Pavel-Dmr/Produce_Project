...
(function () {
  ...
  function Cb() {
    ...
    db = function (a, c, d, h, i, j) {
      var k;
      b
        ? ((k = ya.UTC.apply(0, arguments)), (k += Va(k)))
        : (k = new ya(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0)).getTime());
      return k;
    };
    qb = c + "Minutes";
    rb = c + "Hours";
  ...
  B.numberFormat = function (a, b, c, d) {
    var e = S.lang,
      ...
      f =
        b === -1
          ? z((a.toString().split(".")[1] || "").length, 20)
          : isNaN((b = N(b)))
          ? 2
          : b,
  ...
  S = {
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        "http://code.highcharts.com/4.1.8/modules/canvas-tools.js",
      VMLRadialGradientURL:
        "http://code.highcharts.com/4.1.8/gfx/vml-radial-gradient.png",
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 0,
  ...
  var Tb =
    ...
    na = function (a) {
      ...
      (function (a) {
        a && a.stops
          ? (d = Ta(a.stops, function (a) {
              return na(a[1]);
            }))
          : (c = Tb.exec(a))
          ? (b = [F(c[1]), F(c[2]), F(c[3]), parseFloat(c[4], 10)])
          : (c = Ub.exec(a))
          ? (b = [F(c[1], 16), F(c[2], 16), F(c[3], 16), 1])
          : (c = Vb.exec(a)) && (b = [F(c[1]), F(c[2]), F(c[3]), 1]);
      })(a);
      return {
        get: function (c) {
          var f;
  ...
  P.prototype = {
    opacity: 1,
    textProps:
      "fontSize,fontWeight,fontFamily,fontStyle,color,lineHeight,width,textDecoration,textOverflow,textShadow".split(
        ","
      ),
    init: function (a, b) {
    ...
    colorGradient: function (a, b, c) {
      ...
      if (f) {
        ...
        h[q]
          ? (a = h[q].attr("id"))
          : ((g.id = a = "highcharts-" + wb++),
            (h[q] = i = d.createElement(f).attr(g).add(d.defs)),
            (i.stops = []),
            o(j, function (a) {
              a[1].indexOf("rgba") === 0
                ? ((e = na(a[1])), (k = e.get("rgb")), (m = e.get("a")))
                : ((k = a[1]), (m = 1));
              a = d
                .createElement("stop")
    ...
    clip: function (a) {
      return this.attr(
        "clip-path",
        a ? "url(" + this.renderer.url + "#" + a.id + ")" : O
      );
    },
    crisp: function (a) {
      var b,
        ...
        ? ((d.ontouchstart = function (a) {
          ...
          (d.onclick = function (a) {
            (za.indexOf("Android") === -1 ||
              ya.now() - (c.touchEventFired || 0) > 1100) &&
              b.call(d, a);
          }))
        : (d["on" + a] = b);
      return this;
    ...
    align: function (a, b, c) {
      ...
      f = e.alignedObjects;
      if (a) {
        if (((this.alignOptions = a), (this.alignByTranslate = b), !c || Aa(c)))
    ...
    getBBox: function (a) {
      ...
      var i,
        ...
        m;
      d !== v &&
        ((m = ["", e || 0, g && g.fontSize, f.style.width].join(",")),
        (m =
          d === "" || Ob.test(d) ? "num:" + d.toString().length + m : d + m));
      m && !a && (b = c.cache[m]);
      if (!b) {
        ...
        if (c.isSVG) {
          a = b.width;
          d = b.height;
          if (xa && g && g.fontSize === "11px" && d.toPrecision(3) === "16.9")
            b.height = d = 14;
          if (e)
            (b.width = N(d * aa(h)) + N(a * X(h))),
  ...
  ua.prototype = {
    ...
    init: function (a, b, c, d, e) {
      ...
      this.alignedObjects = [];
      this.url =
        (Ja || fb) && C.getElementsByTagName("base").length
          ? f.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
      ...
      this.createElement("desc")
        .add()
        .element.appendChild(C.createTextNode("Created with Highcharts 4.1.8"));
    ...
    buildText: function (a) {
      for (
        ...
        b.removeChild(g[x]);
      !f && !n && !q && e.indexOf(" ") === -1
        ? b.appendChild(C.createTextNode(u(e)))
        : ((h = /<.*style="([^"]+)".*>/),
          (i = /<.*href="(http[^"]+)".*>/),
          T && T.appendChild(b),
          (e = f
          ...
          o(e, function (e, f) {
            ...
            o(g, function (e) {
              if (e !== "" || g.length === 1) {
                ...
                i.test(e) &&
                  !d &&
                  (J(x, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                  L(x, { cursor: "pointer" }));
                e = u(e.replace(/<(.|\n)*?>/g, "") || " ");
                if (e !== " ") {
                  ...
                  !l &&
                    f &&
                    (!ca && d && L(x, { display: "block" }), J(x, "dy", Q(x)));
                  if (m) {
                    for (
                      var n = e.replace(/([^\^])-/g, "$1- ").split(" "),
                        o =
                          g.length > 1 ||
                          f ||
                          (n.length > 1 && k.whiteSpace !== "nowrap"),
                        T,
                        y,
                        s,
                        t = [],
                      ...
                      (a.rotation = 0),
                        ...
                        !ca &&
                          c.forExport &&
                          (s = c.measureSpanWidth(x.firstChild.data, a.styles)),
                        (T = s > m),
                        y === void 0 && (y = T),
                        q && y
                          ? ((A /= 2),
                          ...
                          ? ((n = t),
                            ...
                            n.length &&
                              ...
                              b.appendChild(x)),
                            s > m && (m = s))
                          : (x.removeChild(x.firstChild), t.unshift(n.pop())),
                        n.length &&
                          x.appendChild(
                            C.createTextNode(n.join(" ").replace(/- /g, "-"))
                          );
    ...
    fontMetrics: function (a, b) {
      ...
      b &&
        K.getComputedStyle &&
        ((b = b.element || b),
        (a = (c = K.getComputedStyle(b, "")) && c.fontSize));
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        a = q.element.style;
        p =
          (t === void 0 || yb === void 0 || n.styles.textAlign) &&
          s(q.textStr) &&
          q.getBBox();
        ...
        if (D) {
          if (!x)
            (a = w(-Q * u) + C),
              ...
              (n.box = x =
                d
                  ? l.symbol(d, a, b, n.width, n.height, G)
                  : l.rect(a, b, n.width, n.height, 0, G[Pb])),
      ...
      function k() {
        var a = n.styles,
          ...
          c;
        c = h ? 0 : B;
        if (s(t) && p && (a === "center" || a === "right"))
          b += { center: 0.5, right: 1 }[a] * (t - p.width);
      ...
      n.onAdd = function () {
        ...
        x && s(e) && n.attr({ anchorX: e, anchorY: f });
      };
  ...
  r(P.prototype, {
    ...
    setSpanRotation: function (a, b, c) {
      ...
      d[e + (Ja ? "Origin" : "-origin")] = d.transformOrigin =
        b * 100 + "% " + c + "px";
      L(this.element, d);
    },
  ...
  if (!ca && !fa) {
    ...
    D.prototype.ySetter =
      D.prototype.widthSetter =
      D.prototype.heightSetter =
        D.prototype.xSetter;
    var La = {
      Element: D,
      ...
      color: function (a, b, c, d) {
        ...
        if (i) {
          ...
          o(a, function (a, b) {
            g.test(a[1])
              ? ((f = na(a[1])), (k = f.get("rgb")), (m = f.get("a")))
              : ((k = a[1]), (m = 1));
            t.push(a[0] * 100 + "% " + k);
            b ? ((x = m), (p = k)) : ((q = m), (Q = k));
          });
            ...
            if (i === "gradient")
              ...
              var j = l.r,
                ...
                j = function () {
                  A &&
                    ((C = d.getBBox()),
                    (r += (A[0] - C.x) / C.width - 0.5),
                    (z += (A[1] - C.y) / C.height - 0.5),
                    (v *= A[2] / C.width),
                    (w *= A[2] / C.height));
                  u =
                    'src="' +
  ...
  Ra.prototype = {
    ...
    handleOverflow: function (a) {
      ...
      if (h)
        ...
        k < b.slotWidth &&
          b.labelAlign === "center" &&
          (a.x += m * (b.slotWidth - k - i * (b.slotWidth - z(j, k)))),
      ...
      if (l && Q)
        y === "inside" && (Q = -Q),
          ...
          n
            ...
            : (this.mark = f
                .path(h)
                .attr({ stroke: u, "stroke-width": l, opacity: c })
                .add(d.axisGroup));
      if (i && !isNaN(z))
        (i.xy = r = this.getLabelPosition(z, r, i, g, k, w, a, t)),
  ...
  B.PlotLineOrBand.prototype = {
    render: function () {
      ...
      if (s(p)) u.zIndex = p;
      if (l)
        if (n) l.animate({ d: n }, null, l.onGetPath);
        else {
          if (
            (l.hide(),
  ...
  ha.prototype = {
    ...
    defaultLabelFormatter: function () {
      ...
      g === v &&
        (g =
          N(b) >= 1e4 ? B.numberFormat(b, -1) : B.numberFormat(b, -1, v, ""));
      return g;
    },
        ...
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((d = c.xData), d.length))
              (a.dataMin = z(p(a.dataMin, d[0]), Na(d))),
    ...
    translate: function (a, b, c, d, e, f) {
      ...
      b
        ...
        : (e && (a = g.val2lin(a)),
          f === "between" && (f = 0.5),
          (a =
            h * (a - d) * j + i + h * k + (qa(f) ? j * f * g.pointRange : 0)));
      return a;
    },
    ...
    getPlotLinePath: function (a, b, c, d, e) {
      ...
      isNaN(e)
        ? (l = !0)
        : this.horiz
        ? ((i = h), (j = k - this.bottom), (a = c = n(a, g, g + this.width)))
        : ((a = g), (c = m - this.right), (i = j = n(i, h, h + this.height)));
      return l && !d
        ? null
    ...
    setTickInterval: function (a) {
      ...
      h
        ? ((b.linkedParent = c[b.coll][d.linkedTo]),
          ...
          d.type !== b.linkedParent.options.type && la(11, 1))
      ...
      if (b.range && s(b.max))
        (b.userMin = b.min = t(b.min, b.minFromRange())),
          (b.userMax = b.max),
          (b.range = null);
      ...
      b.tickInterval =
        b.min === b.max || b.min === void 0 || b.max === void 0
          ? 1
          : h && !k && m === b.linkedParent.options.tickPixelInterval
      ...
      var a = this.chart,
        ...
        i = (this.slotWidth =
          (f &&
            !e.step &&
            !e.rotation &&
            ((this.staggerLines || 1) * a.plotWidth) / h) ||
      ...
      if (this.autoRotation)
        ...
        for (i = c.length; !f && i--; )
          if (((j = c[i]), (j = d[j].label)))
            if (
              (j.styles.textOverflow === "ellipsis" &&
                j.css({ textOverflow: "clip" }),
    ...
    hasData: function () {
      return (
        ...
        (s(this.min) && s(this.max) && !!this.tickPositions)
      );
    },
    getOffset: function () {
      var a = this,
    ...
    render: function () {
      ...
      if (a.hasData() || f) {
        ...
        if (
          ...
          i[-1] || (i[-1] = new Ra(a, -1, null, !0)), i[-1].render(-1);
        l &&
          o(g, function (b, c) {
            if (c % 2 === 0 && b < a.max)
  ...
  ha.prototype.getTimeTicks = function (a, b, c, d) {
    ...
    if (s(b)) {
      ...
      j >= E.month &&
        (i[ub](j >= E.year ? 0 : k * V(i[Xa]() / k)), (h = i[Ya]()));
      ...
      for (
        var d = i.getTime(),
          m = i[Xa](),
          l = i[Wa](),
          n = (E.day + (g ? Va(i) : i.getTimezoneOffset() * 6e4)) % E.day;
        d < c;
  ...
  ha.prototype.getLogTickPositions = function (a, b, c, d) {
    ...
    if (a >= 0.5) (a = w(a)), (g = this.getLinearTickPositions(a, b, c));
      ...
      (a = ob(a, null, nb(a))),
      (g = Ta(this.getLinearTickPositions(a, b, c), Ba)),
      !d)
    )
  ...
  Mb.prototype = {
    ...
    refresh: function (a, b) {
      ...
      j === !1
        ? this.hide()
        : (this.isHidden && (kb(d), d.attr("opacity", 1).show()),
          d.attr({ text: j }),
    ...
    getXDateFormat: function (a, b, c) {
      ...
      if (e) {
        ...
        for (f in E) {
          if (
            e === E.week &&
            +Ma("%w", a.x) === c.options.startOfWeek &&
  ...
  Ua.prototype = {
    ...
    runPointActions: function (a) {
      ...
      !e && g && g.directTouch && f
        ...
        : (o(c, function (b) {
            ...
            b.visible &&
              ...
              (n = b.searchPoint(a, !j && b.kdDimensions === 1)) &&
              m.push(n);
          }),
          o(m, function (a) {
      ...
      if (l && (l !== this.prevKDPoint || (d && d.isHidden))) {
        if (e && !l.series.noSharedTooltip) {
          for (h = m.length; h--; )
            (m[h].clientX !== l.clientX || m[h].series.noSharedTooltip) &&
              m.splice(h, 1);
    ...
    drag: function (a) {
      ...
      if (!l || !l.touch)
        if (
          ...
          l &&
            g &&
            ((d = e - q), l.attr({ height: N(d), y: (d > 0 ? 0 : d) + q }));
    ...
    destroy: function () {
      ...
      ab ||
        (Z(C, "mouseup", this.onDocumentMouseUp),
        Z(C, "touchend", this.onDocumentTouchEnd));
  ...
  r(B.Pointer.prototype, {
    ...
    pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
      ...
      b < u.min
        ? ((b = u.min), (z = !0))
        : b + q > u.max && ((b = u.max - q), (z = !0));
      z
        ? ((r -= 0.8 * (r - g[j][0])), t || (v -= 0.8 * (v - g[j][1])), c())
        : (g[j] = [r, v]);
      o || ((f[j] = x - n), (f[l] = q));
      f = o ? 1 / p : p;
      e[l] = q;
    ...
    pinch: function (a) {
      ...
      if (a.type === "touchstart")
        ...
        if (!i)
          b.selectionMarker = i = r({ destroy: ta, touch: !0 }, c.plotBox);
  ...
  if (K.PointerEvent || K.MSPointerEvent) {
    ...
    Sa(Ua.prototype, "init", function (a, b, c) {
      a.call(this, b, c);
      this.hasZoom &&
        L(b.container, { "-ms-touch-action": O, "touch-action": O });
    });
  ...
  lb.prototype = {
    ...
    renderItem: function (a) {
      ...
      if (!o) {
        ...
        a.legendItem = o = c
          .text("", m ? f + g : -g, this.baseline || 0, y)
          .css(A(a.visible ? h : i))
      ...
      if (e && this.itemX - x + f > (l || b.chartWidth - 2 * j - x - d.x))
        (this.itemX = x),
    ...
    getAllItems: function () {
      ...
      o(this.chart.series, function (b) {
        var c = b.options;
        if (p(c.showInLegend, !s(c.linkedTo) ? v : !1, !0))
          a = a.concat(
  ...
  (/Trident\/7\.0/.test(za) || Ja) &&
    Sa(lb.prototype, "positionItem", function (a, b) {
      var c = this,
        d = function () {
  ...
  D.prototype = {
    ...
    redraw: function (a) {
      ...
      if (h)
        for (m = k; m--; ) if (((a = c[m]), a.options.stacking)) a.isDirty = !0;
      o(c, function (a) {
        a.isDirty &&
      ...
      if (k)
        f
          ...
          : (this.plotBackground = b
              ...
              .shadow(a.plotShadow));
      if (m)
        h ? h.animate(u) : (this.plotBGImage = b.image(m, q, p, o, t).add());
      s
        ? s.animate({ width: r.width, height: r.height })
        : (this.clipRect = b.clipRect(r));
      if (l)
        g
          ? g.animate(
              g.crisp({ x: q, y: p, width: o, height: t, strokeWidth: -l })
            )
          : (this.plotBorder = b
              .rect(q, p, o, t, 0, -l)
              .attr({
    ...
    linkSeries: function () {
      ...
      o(b, function (b) {
        ...
        if (Aa(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))
    ...
    isReadyToRender: function () {
      var a = this;
      return (!ca && K == K.top && C.readyState !== "complete") ||
        (fa && !K.canvg)
        ? (fa
            ? Lb.push(function () {
                a.firstRender();
  ...
  R.prototype = {
      ...
      if (
        ...
        if (n && h > n) {
          ...
          if (qa(k)) {
            ...
            if (t)
              for (c = 0; c < h; c++)
                (i = a[c]), (q[c] = i[0]), (x[c] = i.slice(1, t + 1));
            else
    ...
    processData: function (a) {
      ...
      if (k && this.sorted && (!i || d > i || this.forceCrop))
        if (b[d - 1] < m || b[0] > l) (b = []), (c = []);
          ...
          (e = this.cropData(this.xData, this.yData, m, l)),
            (b = e.xData),
            (c = e.yData),
            (e = e.start),
            (f = !0);
    ...
    generatePoints: function () {
      ...
      for (l = 0; l < g; l++)
        (i = h + l),
          j
            ? (m[l] = new f().init(this, [d[l]].concat(ra(e[l]))))
            : (b[i]
                ? (k = b[i])
                : a[i] !== v && (b[i] = k = new f().init(this, a[i], d[l])),
              (m[l] = k)),
          (m[l].index = i);
      if (b && (g !== (c = b.length) || j))
        for (l = 0; l < c; l++)
          if ((l === h && !j && (l += g), b[l]))
            b[l].destroyElements(), (b[l].plotX = v);
      this.data = b;
      this.points = m;
    },
    ...
    translate: function () {
      ...
      for (
        ...
        var y =
          b &&
          e.stacks[
            (this.negStacks && u < (m ? 0 : k) ? "-" : "") + this.stackKey
          ];
        if (e.isLog && u !== null && u <= 0) (r.y = u = null), la(10);
        r.plotX = l = z(
          t(-1e5, c.translate(w, 0, 0, 0, 1, i, this.type === "flags")),
          1e5
        );
        if (b && this.visible && y && y[w])
          (y = y[w]),
        ...
        r.plotY = n =
          typeof u === "number" && u !== Infinity
            ? z(t(-1e5, e.translate(u, 0, 1, 0, 1)), 1e5)
            : v;
    ...
    drawPoints: function () {
      var a,
        ...
        s = p(
          m.enabled,
          this.xAxis.isRadial,
          this.closestPointRangePx > 2 * m.radius
        );
            ...
            if (
              ...
              if (o && (h > 0 || j))
                g.graphic = c.renderer
                  .symbol(i, d - h, e - h, 2 * h, 2 * h, q ? n : m)
                  .attr(a)
                  .add(t);
            }
    ...
    getAttribs: function () {
      ...
      if (!k || g < k || j)
        for (; g--; ) {
          k = i[g];
          if (
            (c = (k.options && k.options.marker) || k.options) &&
            c.enabled === !1
          )
            c.radius = 0;
          if (p.length) {
          ...
          if (j) {
            ...
            if (!b.marker)
              f.color =
                f.color ||
                (!k.options.color &&
                  e[k.negative && h ? "negativeColor" : "color"]) ||
                na(k.color)
      ...
      if (d.length && (i || j) && m.min !== v)
        i && i.hide(),
          ...
          o(d, function (d, o) {
            ...
            u = t(e, f);
            if (m.isXAxis) {
              if (((h = { x: q ? u : s, y: 0, width: r, height: k }), !x))
                h.x = b.plotHeight - h.x;
            } else if (((h = { x: 0, y: q ? u : s, width: k, height: r }), x)) h.y = b.plotWidth - h.y;
            b.inverted &&
              c.isVML &&
              (h = m.isXAxis
                ? { x: 0, y: n ? s : u, height: h.width, width: b.chartWidth }
                : {
  ...
  R.prototype.setStackedPoints = function () {
    if (
      ...
      for (s = 0; s < d; s++) {
        ...
        if (!l[o][u])
          n[o] && n[o][u]
            ? ((l[o][u] = n[o][u]), (l[o][u].total = null))
            : (l[o][u] = new Hb(m, m.options.stackLabels, q, u, h));
        o = l[o][u];
        ...
        e === "percent"
          ? ((q = q ? i : j),
            k && l[q] && l[q][u]
              ? ((q = l[q][u]),
                (o.total = q.total = t(q.total, o.total) + N(y) || 0))
              : (o.total = ea(o.total + (N(y) || 0))))
          : (o.total = ea(o.total + (y || 0)));
        o.cum = p(o.cum, g) + (y || 0);
  ...
  wa = ka(R, {
    ...
    getPointSpline: function (a, b, c) {
      ...
      if (f && g) {
        ...
        i > a && i > e
          ? ((i = t(a, e)), (k = 2 * e - i))
          : i < a && i < e && ((i = z(a, e)), (k = 2 * e - i));
        k > g && k > e
          ? ((k = t(g, e)), (i = 2 * e - k))
          : k < g && k < e && ((k = z(g, e)), (i = 2 * e - k));
        b.rightContX = j;
        b.rightContY = k;
      }
      c
  ...
  wa = ka(R, {
    ...
    getColumnMetrics: function () {
      ...
      var j = z(
        ...
        b = z(
          ...
          p(b.pointWidth, m * (1 - 2 * b.pointPadding))
        );
      return (a.columnMetrics = {
        ...
        offset:
          (m - b) / 2 +
          (k +
            ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * m -
            j / 2) *
            (e ? -1 : 1),
      });
    },
    translate: function () {
      ...
      o(a.points, function (c) {
        ...
        N(y) < g &&
          g &&
          ((y = g),
          (v = (!e.reversed && !c.negative) || (e.reversed && c.negative)),
          (s = w(N(s - f) > g ? d - g : f - (v ? g : 0))));
        c.barX = o;
        c.pointWidth = i;
        r = w(o + r) + m;
        o = w(o) + m;
        ...
        c.tooltipPos = b.inverted
          ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - o - r / 2, y]
          : [o + r / 2, h + e.pos - b.plotTop, y];
        c.shapeType = "rect";
      ...
      o(a.points, function (h) {
        ...
        if (i !== v && !isNaN(i) && h.y !== null)
          (f = h.shapeArgs),
            ...
            j
              ? (kb(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](A(f)))
    ...
    animate: function (a) {
      ...
      if (ca)
        a
          ? ((e.scaleY = 0.001),
            (a = z(b.pos + b.len, t(b.pos, b.toPixels(c.threshold)))),
      ...
      a.dlProcessOptions && a.dlProcessOptions(d),
        ...
        o(e, function (e) {
          ...
          if (n && !h) e.dataLabel = n.destroy();
            ...
            if (n)
              if (s(i)) n.attr({ text: i }), (z = !1);
              else {
                if (((e.dataLabel = n = n.destroy()), w))
  ...
  if (M.pie)
    (M.pie.prototype.drawDataLabels = function () {
      ...
      if (a.visible && (e.enabled || a._hasPointLabels)) {
          ...
          if (K) {
            ...
            for (G = b = 0; !b && H[G]; )
              (b =
                H[G] &&
                H[G].dataLabel &&
                (H[G].dataLabel.getBBox().height || 21)),
                G++;
            if (l > 0) {
              ...
              for (G = 0; G < K; G++) {
                ...
                var P, O;
                for (O = 0; O < u; O++)
                  (P = N(I[O] - y[1])), P < c && ((c = P), (J = O));
                if (J < G && I[G] !== null) J = G;
                else
                  for (
                    u < K - G + J && I[G] !== null && (J = u - K + G);
                    I[J] === null;
            ...
            for (G = 0; G < K; G++) {
              ...
              if (l > 0) {
                if (
                  ...
                  (J = u.i),
                  (B = u.y),
                  (c > B && I[J + 1] !== null) || (c < B && I[J - 1] !== null))
                )
                  B = z(t(0, c), d.plotHeight);
              } else B = c;
              A = e.justify
                ? n[0] + (F ? -1 : 1) * (q + l)
                : a.getX(B === r - q - l || B === r + q + l ? c : B, F);
              v._attr = { visibility: D, align: y[6] };
              v._pos = {
                x: A + e.x + ({ left: f, right: -f }[y[6]] || 0),
                y: B + e.y - 10,
              };
              v.connX = A;
              v.connY = B;
        ...
        if (Ca(E) === 0 || this.verifyDataLabelOverflow(E))
      ...
      (M.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        d[1] !== null
          ? (f = t(z(f, b[2] - t(a[0], a[2])), e))
          : ((f = t(z(f, b[2] - a[0] - a[2]), e)), (b[1] += (a[0] - a[2]) / 2));
        f < b[2]
          ? ((b[2] = f),
            (b[3] = /%$/.test(c.innerSize || 0)
  ...
  if (M.column)
    M.column.prototype.alignDataLabel = function (a, b, c, d, e) {
  ...
  r(Ea.prototype, {
    ...
    onMouseOut: function () {
      ...
      if (!b || Ka(this, b) === -1) this.setState(), (a.hoverPoint = null);
    },
    ...
    setState: function (a, b) {
      ...
      if (
        !(
          ...
          (f[a] && f[a].enabled === !1) ||
          (a && (j || (h && i.enabled === !1))) ||
          (a && m.states && m.states[a] && m.states[a].enabled === !1)
        )
      ) {
        if (this.graphic)
          (g = g && this.graphic.symbolName && o.r),
            this.graphic.attr(
              A(o, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})
            ),
            k && k.hide();
        else {
          if (a && i)
